...
@section('content')
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action={{ route('data-desa.update', ['data_desa' => $data_desa->id_desa]) }} method="post"
                    ...
                    <fieldset>
                        <div class="mb-3">
                            ...
                            <input type="text" id="id_desa" class="form-control" placeholder="Masukkan id desa"
                                name="id_desa" value="{{ $data_desa->id_desa }}" disabled>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" id="id_kecamatan" class="form-control" placeholder="Masukkan id kecamatan"
                                name="id_kecamatan" value="{{ $data_desa->id_kecamatan }}" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="nama-data-desa" class="form-label">Nama Kecmatan</label>
                            <input type="text" id="nama-data-desa" name="name" class="form-control"
                                placeholder="Nama Desa" value="{{ $data_desa->name }}">
                        </div>
                    </fieldset>
