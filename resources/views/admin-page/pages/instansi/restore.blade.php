<div class="modal fade" id="modalRestore{{ $item->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <p class="mb-1">Apakah anda yakin ingin mengembalikan data instansi</p>
                    <h5 class="mt-2 text-center">{{ $item->nama }}</h3>
                </div>
            </div>
            <div class="modal-footer">
                <form action="{{ route('instansi.restore', ['id' => $item->id]) }}" method="post">
                    @csrf
                    @method('PUT')
