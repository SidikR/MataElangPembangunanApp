...
@section('content')
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action={{ route('instansi.edit', ['instansi' => $instansi->id]) }}>
                    <fieldset disabled>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="alamat" cols="15" rows="5">{{ $instansi->alamat }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="deskripsi" class="form-label">Deskripsi</label>
                            <textarea class="form-control" id="deskripsi" cols="15" rows="5">{{ $instansi->deskripsi }}</textarea>
                        </div>
                    </fieldset>
