...
@section('content')
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action={{ route('data-kecamatan.edit', ['data_kecamatan' => $data_kecamatan->id_kecamatan]) }}>
                    <fieldset disabled>
                        <div class="mb-3">
                            ...
                            <input type="text" id="id_kecamatan" class="form-control" placeholder="Masukkan id kecamatan"
                                name="id_kecamatan" value="{{ $data_kecamatan->id_kecamatan }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" id="id_kabupaten" class="form-control" placeholder="Masukkan id kabupaten"
                                name="id_kabupaten" value="{{ $data_kecamatan->id_kabupaten }}">
                        </div>
                        <div class="mb-3">
                            <label for="nama-data-kecamatan" class="form-label">Nama Kecmatan</label>
                            <input type="text" id="nama-data-kecamatan" class="form-control" placeholder="Nama Kecamatan"
                                value="{{ $data_kecamatan->name }}">
                        </div>
                    </fieldset>
