<div class="modal fade" id="modalDeletePermanent{{ $index }}" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <p class="mb-1">Apakah anda yakin ingin delete permanent data kecamatan</p>
                    <h5 class="mt-2 text-center">{{ $item->name }}</h3>
                </div>
            </div>
            <div class="modal-footer">
                <form action="{{ route('data-kecamatan.permanent-delete', ['id' => $item->id_kecamatan]) }}"
                    method="post">
                    @csrf
                    @method('DELETE')
