...
<head>
    ...
    <!-- Favicons -->
    <link rel="icon" href="{{ asset('assets/img/lamsel.png') }}" type="image/x-icon">
    ...
    <link rel="stylesheet" href="https://unpkg.com/leaflet-fullscreen/dist/leaflet.fullscreen.min.css" />
    <script src="https://unpkg.com/leaflet-fullscreen/dist/Leaflet.fullscreen.min.js"></script>

    <!-- Leaflet Sidebar CSS and JS -->
...
<body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
            ...
            <div class="row gy-4">
                <div class="col-lg-5 col-md-12 footer-about">
                    <a href="index.html" class="logo d-flex align-items-center">
                        <span>Mata Elang Pembangunan</span>
                    </a>
    ...
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <script src="{{ asset('assets/vendor/leaflet-easyprint/dist/bundle.js') }}"></script>
